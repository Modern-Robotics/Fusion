#===============================================================================
# 11-April-2019 <jwa> -- This python script is depreciated.  Nothing calls it,
#    the Fusion Server takes care of managing the wireless connections directly,
#    and the new rc.local processing takes care of assigning the utilization of
#    of the wireless (and wired) assets.  
#
#    In short, we don't need this right now but I'm keeping it for reference.
#################################################################################
