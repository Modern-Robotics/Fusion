#===============================================================================
# hostapd.conf__npp.sh - FusionOS/NIC hostapd.conf configuration file
#-------------------------------------------------------------------------------
# 30-Apr-2019 <jwa> - Inserted dummy strings for the SSID/Passkey; in this 
#      configuration, there is no WAP on the unit
