angular
    .module('fusionApp')
    .controller('headerCtrl', ['$scope', '$mdSidenav', '$mdDialog', 'appFactory', 'userFactory', '$location', 'socketFactory', '$state', '$translate', function ($scope, $mdSidenav, $mdDialog, appFactory, userFactory, $location, socketFactory, $state, $translate) {
