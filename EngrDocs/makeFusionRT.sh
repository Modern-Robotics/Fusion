...
#
DEV_BRANCH="FusionServer-v1.3.2c-RC1"
RT_BUILDID="FRT-v1.3.2cRC1b02"
...
#
GIT_PUSH_DEV="yes"		# yes or no -> should the Dev     repo be cloned
GIT_PUSH_RT="yes"		# yes or no -> should the Runtime repo be cloned
#
################################################################################
