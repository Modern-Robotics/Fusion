...
if [[ ${FRT_BRANCH} ]] ; then
	FOS_NEWVER=`sudo curl --silent --show-error https://raw.githubusercontent.com/Modern-Robotics/Fusion/${FRT_BRANCH}/update.sh`
else
	FOS_NEWVER=`sudo curl --silent --show-error https://raw.githubusercontent.com/Modern-Robotics/Fusion/master/update.sh`
fi
