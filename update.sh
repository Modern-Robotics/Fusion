...
#-------------------------------------------------------------------------------
# Revision History
# 04-May-2022 <jwa> - Bypassed apt updates as they are no longer profitable.
# 22-Mar-2022 <jwa> - Officially made this script part of the FRT codebase to
#                     incorporate the 27-aug-21 modifications.
...
#REPO_NAME="Fusion.git"
#REPO_BRANCH="master"
#REPO_ADDRESS="http://www.github.com/Modern-Robotics/${REPO_NAME}/${REPO_BRANCH}/"
#REPO_DIRECT="https://raw.githubusercontent.com/${REPO_NAME}/${REPO_BRANCH}/"
...
if [[ ${FRT_BRANCH} ]] ; then
	...
	vecho "<<< using FRT_BRANCH=${FRT_BRANCH} to get NewVersion=${FOS_NEWVER} >>>"
else
	...
	vecho "<<< Using LAST_TAG=${LAST_TAG} to get NewVersion=${FOS_NEWVER} >>>"
fi
...
# -------------------------------------------------------------------
# 04-May-2022 <jwa> - This is fruitless so let's skip it...
...
#===============================================================================
# If we are doing an install (presumably as part of the FusionOS Build process,
